...
contract("Election", function(accounts) {
  ...
  it("it initializes the candidates with the correct values", function() {
    return Election.deployed().then(function(instance) {
      ...
      assert.equal(candidate[1], "Rachel Green", "contains the correct name");
      ...
      assert.equal(candidate[1], "Monica Geller", "contains the correct name");
      assert.equal(candidate[2], "Indian National Congress", "contains the correct party");
      assert.equal(candidate[3], 0, "contains the correct votes count");
      return electionInstance.candidates(3);
    }).then(function(candidate) {
      assert.equal(candidate[0], 3, "contains the correct id");
      assert.equal(candidate[1], "Phoebe Buffay", "contains the correct name");
      ...
      assert.equal(candidate[1], "Joey Tribbiani", "contains the correct name");
      ...
      assert.equal(candidate[1], "Chandler Bing", "contains the correct name");
      ...
      assert.equal(candidate[1], "Ross Geller", "contains the correct name");
      assert.equal(candidate[2], "Aam Admi Party", "contains the correct party");
      assert.equal(candidate[3], 0, "contains the correct votes count");
    });
  });
